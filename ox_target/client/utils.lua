...
function utils.getTexture()
    return lib.requestStreamedTextureDict('menu_textures'), 'medal_gang_take_gold'
end
...
local colour = vector(132, 189, 255, 175)
...
SetTimeout(0, function()
   ...
   if utils.hasExport('codex_core.getLibClient') then
        require 'client.framework.codexcore'
    end
end)
